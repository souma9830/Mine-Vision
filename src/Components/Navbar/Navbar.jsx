    ...
    return(
        <>
            <nav 
                ...
                <button className='items-center hidden gap-2 px-6 py-2 font-semibold text-gray-900 transition-all bg-blue-400 md:flex rounded-2xl hover:bg-blue-600 ease group'>
                    SignUp/SignIn 
                ...
                <button onClick={()=>setIsOpen(!isOpen)}  className='relative mr-4 text-4xl md:hidden'>{isOpen?<RxCross1 />:<RiMenu3Fill />}</button>
