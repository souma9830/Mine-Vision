        ...
        <>
            <nav 
                ...
                <ul className='hidden text-xl font-semibold gap-7 md:flex justify-evenly'>
                    ...
                    <li className='transition-all cursor-pointer hover:text-blue-400 ease'>Feature</li>
                    <li className='transition-all cursor-pointer hover:text-blue-400 ease'>Conatct</li>
                </ul>

                <button onClick={()=>setIspoped(!isPoped)} className='items-center hidden gap-2 px-6 py-2 font-semibold text-white transition-all bg-emerald-500 md:flex rounded-2xl hover:bg-blue-600 ease group'>
                    SignUp/SignIn 
